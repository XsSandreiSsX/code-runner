...
@router.get(
    ...
    responses={404: {"description": "Not found test suite", "model": SwaggerError}},
)
...
@router.delete(
    ...
    responses={
        200: {"description": "Successfully deleted test suite"},
        404: {"description": "Not found test suite", "model": SwaggerError},
    },
)
...
@router.patch(
    ...
    response_model=ClientResponse[None],
    responses={
        200: {"description": "Successfully updated test suite"},
        404: {"description": "Not found test suite", "model": SwaggerError},
    },
)
